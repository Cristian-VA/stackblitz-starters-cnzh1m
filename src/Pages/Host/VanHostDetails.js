...
export default function VanHostDetails (){
  ...
  React.useEffect(() => {
    if (params.id === ":1"){
      setCurrentVan(vansArray[0])
    } else if (params.id === ":2"){
      setCurrentVan(vansArray[1])
    }else if (params.id === ":3"){
      setCurrentVan(vansArray[2])
    }else if (params.id === ":4"){
      setCurrentVan(vansArray[3])
    }else if (params.id === ":5"){
      setCurrentVan(vansArray[4])
    }else if (params.id === ":6"){
      setCurrentVan(vansArray[5])
    }
}, [params.id])
